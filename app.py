...
# CONFIG
# =============================
API_BASE = os.getenv("API_BASE", "https://movie-rec-api-v5yo.onrender.com").rstrip("/")
...
def api_get_json(path: str, params: dict | None = None):
    try:
        ...
        return None, "Backend cold start timeout (Render Free Tier goes to sleep after 15m). The server is waking up now—please wait 5-10 seconds and click Rerun/Refresh!"
